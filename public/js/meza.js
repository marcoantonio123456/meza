...
!function(t) {
    ...
    var r = n(6),
        ...
        c = function(t, e, n) {
            ...
            for (s in p && (n = e), n)
                (f = !d && m && void 0 !== m[s]) && u(g, s) || (l = f ? m[s] : n[s], g[s] = p && "function" != typeof m[s] ? n[s] : E && f ? o(l, r) : _ && m[s] == l ? function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = _, e.getIn = g, e.set = y, e.setIn = m, e.update = I, e.updateIn = T, e.merge = b, e.mergeDeep = O, e.mergeIn = w, e.omit = S, e.addDefaults = A;
    /*!
 * Timm
 *
 ...
 */
            ...
            j = f(function(e) {
                ...
                function i(t, e, n) {
                    if (t) {
                        ...
                        if (e || (this.timer && this.timer.destroy(), this.queue = [], this.active = !1), "number" == i && e)
    ...
    t.exports = function(t, e, n, v, h, E, _) {
        ...
        var g,
            ...
            x = "Array" == e && w.entries || S;
        if (x && (m = f(x.call(new t))) !== Object.prototype && m.next && (s(m, T, !0), r || "function" == typeof m[l] || a(m, l, p)), b && S && "values" !== S.name && (O = !0, A = function() {
            return S.call(this)
        }), r && !_ || !d && !O && w[l] || a(w, l, A), u[e] = A, u[T] = p, h)
            if (g = {
                values: b ? A : I("values"),
                keys: E ? A : I("keys"),
                entries: R
    ...
    var r = n(19),
        ...
        c = function() {
            var t,
                e = n(87)("iframe"),
                r = o.length;
            for (e.style.display = "none", n(149).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), c = t.F; r--;)
    ...
    var b = g.IX2EngineEventTypes,
        O = b.MOUSE_CLICK,
        w = b.MOUSE_SECOND_CLICK,
                                    ...
                                    a && t.forEach(function(t, r) {
                                        ...
                                        !function(t) {
                                            var e = t.store,
                                                ...
                                                T = c.id;
                                            z(E, a) && (T = K(n, T));
                                            var b = v.hasBoundaryNodes && r ? m.getClosestElement(r, R) : null;
    ...
    function bt(t) {
        ...
        e.dispatch((0, y.instanceAdded)((0, a.default)({
            ...
            t.dispatch((0, y.animationFrameChanged)(Number.POSITIVE_INFINITY, n)), St(t.getState().ixInstances[e], t)
        }(e, l) : (X({
            store: e,
            select: function(t) {
    ...
    n(139), n(166), n(55), n(167), n(168), n(169), n(334), n(335), n(336), t.exports = n(337)
}, function(t, e, n) {
    "use strict";
    var r = n(5);
 ...
 */
    ...
    var r = n(6),
        ...
        z = function(t, e, n) {
            return t === k && z(X, e, n), g(t), e = I(e, !0), g(n), i(G, e) ? (n.enumerable ? (i(t, P) && t[P][e] && (t[P][e] = !1), n = b(n, {
                enumerable: T(0, !1)
            })) : (i(t, P) || x(t, P, T(1, {})), t[P][e] = !0), H(t, e, n)) : x(t, e, n)
        },
        K = function(t, e) {
            g(t);
        ...
        Z = function(t) {
            for (var e, n = t === k, r = L(n ? X : m(t)), o = [], a = 0; r.length > a;)
                !i(G, e = r[a++]) || n && !i(k, e) || o.push(G[e]);
            return o
        };
    V || (u((N = function() {
        ...
        var t = d(arguments.length > 0 ? arguments[0] : void 0),
            e = function(n) {
                this === k && e.call(X, n), i(this, P) && i(this[P], t) && (this[P][t] = !1), H(this, t, T(1, n))
            };
        return o && B && H(k, t, {
            configurable: !0,
            set: e
        ...
        return this._k
    }), w.f = q, S.f = z, n(93).f = O.f = $, n(31).f = Q, n(54).f = Z, o && !n(28) && u(k, "propertyIsEnumerable", Q, !0), v.f = function(t) {
        return W(p(t))
    }), a(a.G + a.W + a.F * !V, {
        Symbol: N
    });
    ...
    r.define("ix", t.exports = function(t, e) {
        ...
        function T() {
            !function() {
                ...
                if (!e.length)
                    return;
                e.each(w), e.each(b), E.length && (r.scroll.on(S), setTimeout(S, 1));
                _.length && r.load(A);
            ...
            if (f) {
                ...
                d && (a.style(u, f.style), e.each(d, function(t) {
                    ...
                    if ("load" !== n) {
                        ...
                        if ("hover" === n)
                            return u.on("mouseenter" + c, a), u.on("mouseleave" + c, s), void (v = v.add(u));
                        if ("scroll" !== n) {
                            var f = m[n];
                            if (f) {
                                var d = u.closest(f);
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        case y.STYLE_OPACITY:
            return {
                value: (0, s.default)(parseFloat(i(t, _.OPACITY)), 1)
            };
        case y.STYLE_SIZE:
            var u = i(t, _.WIDTH),
                c = i(t, _.HEIGHT),
                f = void 0,
                l = void 0;
            return f = a.widthUnit === _.AUTO ? N.test(u) ? parseFloat(u) : parseFloat(n.width) : (0, s.default)(parseFloat(u), parseFloat(n.width)), l = a.heightUnit === _.AUTO ? N.test(c) ? parseFloat(c) : parseFloat(n.height) : (0, s.default)(parseFloat(c), parseFloat(n.height)), {
                widthValue: f,
                heightValue: l
            };
        case y.STYLE_BACKGROUND_COLOR:
        ...
        case y.GENERAL_DISPLAY:
            return {
                value: (0, s.default)(i(t, _.DISPLAY), n.display)
            };
        case y.OBJECT_VALUE:
            return e[o] || {
                    value: 0
        ...
        case y.STYLE_SIZE:
            ...
            if (p === _.AUTO) {
                var T = s(e, _.WIDTH);
                f(e, _.WIDTH, ""), g = l(e, "offsetWidth"), f(e, _.WIDTH, T)
            }
            if (v === _.AUTO) {
                var b = s(e, _.HEIGHT);
                f(e, _.HEIGHT, ""), I = l(e, "offsetHeight"), f(e, _.HEIGHT, b)
            }
            return {
                widthValue: g,
                heightValue: I
        ...
        case _.RENDER_TRANSFORM:
            return function(t, e, n, r, i) {
                var o = G.map(function(t) {
                    ...
                    a = i.setStyle;
                V(t, m.TRANSFORM_PREFIXED, i), a(t, m.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === y.TRANSFORM_MOVE && void 0 !== d || s === y.TRANSFORM_SCALE && void 0 !== d || s === y.TRANSFORM_ROTATE && (void 0 !== f || void 0 !== l)) && a(t, m.TRANSFORM_STYLE_PREFIXED, _.PRESERVE_3D);
                var u,
                    c,
                    s,
                    f,
            ...
            return function(t, e, n, r, i, o) {
                ...
                case y.STYLE_SIZE:
                    var s = r.config,
                        ...
                        h = n.widthValue,
                        E = n.heightValue;
                    void 0 !== h && (d === _.AUTO && (d = "px"), V(t, _.WIDTH, o), a(t, _.WIDTH, h + d)), void 0 !== E && (v === _.AUTO && (v = "px"), V(t, _.HEIGHT, o), a(t, _.HEIGHT, E + v));
                    break;
                case y.STYLE_FILTER:
                    !function(t, e, n, r) {
                ...
                case y.STYLE_TEXT_COLOR:
                    var g = b[u],
                        ...
                        O = n.aValue;
                    V(t, g, o), a(t, g, O >= 1 ? "rgb(" + m + "," + I + "," + T + ")" : "rgba(" + m + "," + I + "," + T + "," + O + ")");
                    break;
                default:
                    var w = c.unit,
                        S = void 0 === w ? "" : w;
    ...
    var T = function(t) {
        ...
        b = Object.freeze((r = {}, (0, u.default)(r, y.STYLE_BACKGROUND_COLOR, _.BACKGROUND_COLOR), (0, u.default)(r, y.STYLE_BORDER, _.BORDER_COLOR), (0, u.default)(r, y.STYLE_TEXT_COLOR, _.COLOR), r)),
        O = Object.freeze((i = {}, (0, u.default)(i, m.TRANSFORM_PREFIXED, _.TRANSFORM), (0, u.default)(i, _.BACKGROUND_COLOR, _.BACKGROUND), (0, u.default)(i, _.OPACITY, _.OPACITY), (0, u.default)(i, _.FILTER, _.FILTER), (0, u.default)(i, _.WIDTH, _.WIDTH), (0, u.default)(i, _.HEIGHT, _.HEIGHT), i)),
        w = {},
        S = 1;
    var A = 1;
    var R = function(t, e) {
    ...
    function L(t) {
        ...
        var R = (0, d.default)(n, "action.config.affectedElements", {})[y || T] || {},
    ...
    e.getItemConfigByKey = function(t, e, n) {
        if ((0, E.isPluginType)(t))
            return (0, E.getPluginConfig)(t)(n, e);
        switch (t) {
        case y.STYLE_FILTER:
    ...
    n(269), t.exports = n(7).Object.assign
}, function(t, e, n) {
    var r = n(18);
    r(r.S + r.F, "Object", {
        assign: n(270)
    ...
    e.ixSession = function() {
        ...
        case d:
            for (var m = e.payload, I = m.width, T = m.mediaQueries, b = T.length, O = null, w = 0; w < b; w++) {
                var S = T[w],
                    A = S.key,
                    R = S.min,
                    x = S.max;
    ...
    var r = n(2),
        ...
        m = function(t, e) {
            ...
            if (g === n && t.current)
                return t;
            for (var m = void 0, I = void 0, T = void 0, b = void 0, O = 0, w = o.length; O < w; O++) {
                var S = o[O],
                    A = S.keyframe,
                    R = S.actionItems;
                if (0 === O && (m = R[0]), y >= A) {
                    ...
                    var x = o[O + 1],
                        L = x && y !== A;
                    I = L ? x.actionItems[0] : null, L && (T = A / 100, b = (x.keyframe - A) / 100)
                }
            }
            var N = {};
            if (m && !I)
                ...
                for (var D = (g - T) / b, j = m.config.easing, F = v(j, D), G = 0, X = a.length; G < X; G++) {
                    var k = a[G],
                        V = _(s, k, m.config),
                        U = (_(s, k, I.config) - V) * F + V;
                    N[k] = U
                }
            return (0, i.merge)(t, {
                position: g,
        ...
        I = function(t, e) {
            ...
            if (r && o) {
                ...
                if (s) {
                    var T = m - a,
                        b = g + y,
                        O = p(Math.min(Math.max(0, T / b), 1));
                    t = (0, i.set)(t, "verboseTimeElapsed", b * O)
                }
                if (I < 0)
                    return t;
                var w = p(Math.min(Math.max(0, I / g), 1)),
                    S = v(E, w),
                    A = {},
                    R = null;
                return d.length && (R = d.reduce(function(t, e) {
                    ...
                    return t[e] = i, t
                }, {})), A.current = R, A.position = w, 1 === w && (A.active = !1, A.complete = !0), (0, i.merge)(t, A)
            }
            return t
        };
    ...
    n(83), n(277), t.exports = n(7).Array.from
}, function(t, e, n) {
    "use strict";
    var r = n(85),
        i = n(18),
    ...
    i(i.S + i.F * !n(283)(function(t) {
        ...
        from: function(t) {
            var e,
                ...
                _ = 0,
                g = f(d);
            if (E && (h = r(h, v > 2 ? arguments[2] : void 0, 2)), null == g || p == Array && u(g))
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        if (e) {
            ...
            if (-1 !== e.indexOf(s)) {
                var i = e.split(s),
                    o = i[0];
                if (r = i[1], o !== document.documentElement.getAttribute(d))
                    return null
            }
            return '[data-w-id^="' + r + '"]'
        }
    ...
    e.default = (r = {}, (0, i.default)(r, A, Et()), (0, i.default)(r, R, _t()), (0, i.default)(r, S, Et()), (0, i.default)(r, w, _t()), (0, i.default)(r, C, Et(!1)), (0, i.default)(r, N, _t(!1)), (0, i.default)(r, x, Et()), (0, i.default)(r, L, _t()), (0, i.default)(r, B, {
        ...
        types: "mousedown"
    })), (0, i.default)(r, T, (0, u.default)({}, it, {
        types: "mouseup"
    })), (0, i.default)(r, b, {
        ...
        handler: function(t) {
            ...
            switch (u) {
            case z:
                O = T ? Math.min(h, window.innerWidth) / window.innerWidth : Math.min(_, window.innerHeight) / window.innerHeight;
                break;
            case K:
                var A = st(),
                    R = A.scrollLeft,
                    ...
                    L = A.scrollWidth,
                    N = A.scrollHeight;
                O = T ? Math.min(R + y, L) / L : Math.min(x + I, N) / N;
                break;
            case Y:
            default:
                w = q(o, s);
            ...
            return b && (O > .95 || O < .05) && (O = Math.round(O)), (u !== Y || S || S !== a.elementHovered) && (O = f ? 1 - O : O, e.dispatch((0, d.parameterChanged)(w, O))), {
                elementHovered: S,
                clientX: h,
                clientY: _,
                pageX: y,
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function y(e, n) {
            ...
            o.handler = null, o.redirect = r.attr("data-redirect"), _.test(c) ? o.handler = O : c || (i ? o.handler = b : g())
        }
        function m(t) {
        ...
        return c.ready = c.design = c.preview = function() {
            !function() {
                ...
                if (u = a + "/signFile", !(n = t(d + " form")).length)
                    return;
                n.each(y)
...
Webflow.require('ix').init([
{
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "stepsA": [{
                "opacity": 1,
                "transition": "transform 1200ms ease 0, opacity 1200ms ease 0",
                "x": "0px",
                "y": "0px",
                "z": "0px"
            }],
...
{
    "slug": "move-into-view-delay-1",
    "name": "Move into view delay 1",
    "value": {
        "style": {
            "opacity": 0,
            "x": "0px",
...
{
    "slug": "move-into-view-delay-2",
    "name": "Move into view delay 2",
    "value": {
        "style": {
            "opacity": 0,
            "x": "0px",
